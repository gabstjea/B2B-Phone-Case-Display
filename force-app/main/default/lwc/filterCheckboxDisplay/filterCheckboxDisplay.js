...
export default class filterCheckboxDisplay extends LightningElement {
    ...
    handleCheckBoxGroup(event) {
      ...
      console.log(JSON.parse(JSON.stringify(facetDisplay)));
      console.log(JSON.parse(JSON.stringify(selectedFacetDisplay)));
    ...
    connectedCallback() {
        console.log('filter checkbox display Initialized');
    } // connectedCallback
